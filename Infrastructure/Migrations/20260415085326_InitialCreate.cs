    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("3d54091d-abc8-49ec-9590-93ad3ed5458f"), "Kraków", "Poland", "31-150", "ul. Św. Filipa 17", 1, new DateTime(2001, 1, 11, 0, 0, 0, 0, DateTimeKind.Unspecified), "Person", new DateTime(2026, 4, 15, 8, 53, 26, 411, DateTimeKind.Utc).AddTicks(838), "adam@wsei.edu.pl", null, "Adam", "Male", "Nowak", null, null, "123456789", "Programista", "Active", null });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("516a34d7-ccfb-4f20-85f3-62bd0f3af271"), "Kraków", "Poland", "31-150", "ul. Św. Filipa 17", 1, null, "Company", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "biuro@wsei.edu.pl", null, "Edukacja", null, null, "WSEI", "123567123", null, null, "Active", null, "https://wsei.edu.pl" });

            migrationBuilder.InsertData(
                table: "Contact",
                columns: new[] { "Id", "Address_City", "Address_Country", "Address_PostalCode", "Address_Street", "Address_Type", "BirthDate", "ContactType", "CreatedAt", "Email", "EmployerId", "FirstName", "Gender", "LastName", "MiddleName", "OrganizationId", "Phone", "Position", "Status", "UpdatedAt" },
                values: new object[] { new Guid("b4dcb17c-f875-43f8-9d66-36597895a466"), "Warszawa", "Poland", "00-001", "ul. Wiejska 1", 1, new DateTime(2001, 1, 11, 0, 0, 0, 0, DateTimeKind.Unspecified), "Person", new DateTime(2026, 4, 15, 8, 53, 26, 411, DateTimeKind.Utc).AddTicks(850), "ewa@wsei.edu.pl", null, "Ewa", "Female", "Kowalska", null, null, "123123123", "Tester", "Blocked", null });
